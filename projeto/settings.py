...
SECRET_KEY = 'django-insecure-@ygwo#nkb^8wv=3nnm2du88*(m!@^j^i5p#f04cfrj&n016f6&'
...
MIDDLEWARE = [
    ...
    'projeto.contas.middleware.ForcarTrocaSenhaMiddleware',
...
DATABASES = {
    'default': {
        ...
        'NAME': 'projetointegrador',  # nome do banco
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {
        'NAME': 'projeto.contas.validators.SenhaForteValidator',
    },
]
...
# Formatação de números/valores no padrão brasileiro
