...
class SenhaForteValidator:
    def validate(self, password, user=None):
        ...
        if not re.search(r"[0-9]", password):
            raise ValidationError(
                _("A senha conter pelo menos um número."),
    ...
    def get_help_text(self):
        return _(
            "A senha deve conter: mínimo 8 caracteres, uma letra maiúscula, uma letra minúscula, um número e um caractere especial."
        )